...
if __name__ == '__main__':
    ...
    import_dir = Path(os.getcwd()).parent / 'output' / 'DEMO' / 'KITTI' / 'pv_rcnn'
    ...
    df = pandas.read_csv('../data/custom/ImageSets/val.txt', header=None)

    index = 4 # has to be -1 of index in all.txt
